...
export default function DogCreate() {
    ...
    function handleSubmit(e) {
        e.preventDefault();
        if (input.minHeight > input.maxHeight || input.minWeigth > input.maxWeigth || input.minlife_span > input.maxlife_span) {
            return alert('Por favor corrige los errores ')
        } else if (input.name === " " || input.maxHeight === " " || input.maxHeight === " " || input.minWeigth === " " || input.maxWeigth === " "
